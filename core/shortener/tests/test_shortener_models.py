...
class TestShortenerModel(TestCase):
    ...
    def test_unique_short_url(self):
        test1 = Shortener.objects.get(user__username='test1', original_url='http://www.example1.com')
        test2 = Shortener.objects.get(user__username='test2', original_url='http://www.example1.com')

        self.assertNotEqual(test1.short_url, test2.short_url)

    def test_str(self):
        test1 = Shortener.objects.get(user__username='test1', original_url='http://www.example1.com')
        test2 = Shortener.objects.get(user__username='test2', original_url='http://www.example2.com')
